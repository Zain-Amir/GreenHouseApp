...
import 'package:green_house_app/screens/LiveChat/config.dart';
import 'package:green_house_app/screens/LiveChat/widgets/ControlsWidget.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> connectLiveKit() async {
    ...
    theRoom = await LiveKitClient.connect(url, token, connectOptions: options, roomOptions: roomOptions);
  ...
  Widget build(BuildContext context) => Scaffold(
        body: Scaffold(
          ...
          body: Column(
            children: [
              Expanded(child: participants.isNotEmpty ? ParticipantWidget.widgetFor(participants.first) : Container()),
              SizedBox(
                height: 100,
